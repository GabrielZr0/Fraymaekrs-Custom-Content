// Hitbox stats
{
	...
	strong_up_attack: {
		hitbox0: { damage: 10, knockbackGrowth: 55, baseKnockback: 60, hitstop: -1, hitstun: -1, angle: 80, limb:AttackLimb.FOOT },
		hitbox1: { damage: 12, knockbackGrowth: 60, baseKnockback: 65, hitstop: -1, selfHitstop:-1, hitstopOffset:3, selfHitstopOffset:3, angle: 90, limb:AttackLimb.FOOT },	
	...
	special_up: {
		hitbox0: {damage: 4, knockbackGrowth: 45, baseKnockback: 70, hitstop: 2, selfHitstop: 2, hitstun: -1, reversibleAngle: false, angle:70, limb:AttackLimb.FIST}
	}, 
	special_up_air: {
		hitbox0: {damage: 4, knockbackGrowth: 45, baseKnockback: 70, hitstop: 2, selfHitstop: 2, hitstun: -1, reversibleAngle: false, angle:70, limb:AttackLimb.FIST}
	}, 
